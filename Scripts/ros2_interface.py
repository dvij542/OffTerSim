...
class CarController(Node):
    def __init__(self):
        ...
        self.publisher_accel = self.create_publisher(
            ...
            'car_accel',
            10)
        self.env = UnityEnvironment(file_name="ros2-env/difficult-privileged", seed=1, side_channels=[],worker_id=0,log_folder='logs/')#,no_graphics=True)
        # print("Started?")
        self.env.reset()
        # print("Started?")
    ...
    def publish_data(self):
        ...
        pcl = []
        inds = [0,8,9,10,11,12,13,14,15,1,2,3,4,5,6,7]
        for k in range(16) :
